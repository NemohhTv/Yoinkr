...
const settingsSchema = z.object({
  ...
  ytDlpBrowserProfile: z.string().max(200),
  ytDlpCookieMode: z.enum(['none', 'browser', 'file', 'paste']),
  ytDlpCookiesFilePath: z.string(),
  ytDlpCookiesPastedText: z.string().max(512 * 1024),
